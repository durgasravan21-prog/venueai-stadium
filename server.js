...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc:      ["'self'", 'data:', 'blob:', 'https://images.unsplash.com', 'https://*.unsplash.com', 'https://upload.wikimedia.org', 'https://*.googleusercontent.com', 'https://api.dicebear.com', 'https://api.qrserver.com', 'https://chart.googleapis.com', 'https://quickchart.io'],
      connectSrc:  ["'self'", 'wss:', 'ws:', 'https:', 'http:', 
                    'https://*.firebaseio.com', 'https://*.googleapis.com', 'https://accounts.google.com', 'https://www.gstatic.com', 'https://*.firebaseapp.com'],
      frameSrc:    ["'self'", 'https://checkout.razorpay.com', 'https://accounts.google.com', 'https://*.firebaseapp.com', 'https://www.google.com', 'https://www.google.co.in'],
      objectSrc:   ["'none'"],
      workerSrc:   ["'self'", 'blob:'],
    },
  },
